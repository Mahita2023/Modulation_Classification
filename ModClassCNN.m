function modClassNet = ModClassCNN(modulationTypes,sps,spf)
...
modClassNet = [
  ...
  convolution2dLayer(filterSize, 80*netWidth, 'Padding', 'same', 'Name', 'CNN6')
  batchNormalizationLayer('Name', 'BN6')
  reluLayer('Name', 'ReLU6')
  
  convolution2dLayer(filterSize, 96*netWidth, 'Padding', 'same', 'Name', 'CNN7')
  batchNormalizationLayer('Name', 'BN7')
  reluLayer('Name', 'ReLU7')
  
  convolution2dLayer(filterSize, 112*netWidth, 'Padding', 'same', 'Name', 'CNN8')
  batchNormalizationLayer('Name', 'BN8')
  reluLayer('Name', 'ReLU8')
  
  convolution2dLayer(filterSize, 128*netWidth, 'Padding', 'same', 'Name', 'CNN9')
